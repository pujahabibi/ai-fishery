  ...
  def __init__(self, ipynb=False, theme='black', 
    ...
    if dataset == 'coco_hp':
      ...
      self.colors_hp = [(255, 0, 255), (255, 0, 0), (0, 0, 255), 
        ...
        (255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255),
        (255, 0, 0), (0, 0, 255)]
    elif num_classes == 128 or dataset == 'coco':
...
coco_class_name = [
    ...
    # 't1_jenis_pekerjaan',
    # 't1_golongan_darah',
    # 't2_status_perkawinan',
    # 't2_tanggal_perkawinan',
    # 't2_status_hubungan',
    # 't2_kewarganegaraan',
    # 't2_no_passpor',
    # 't2_no_kitap',
    # 't2_ayah',
    #'t2_ibu', #'pekerjaan', 'alamat', 'no_ktp_tdp', 'dikeluarkan', 'pada_tanggal'
]
